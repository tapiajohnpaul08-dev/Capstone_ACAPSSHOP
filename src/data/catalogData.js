// Resolve assets at module load time so Vite can process them
function asset(path) {
  return new URL(`../assets/products/${path}`, import.meta.url).href
}
...
export const products = [
  ...
  },
  {
    ...
    image: asset('3. PP SLIM CUPS.png'),
    sizes: [
  ...
  },
  {
    ...
    image: asset('7. SINGLE WALL PAPER CUP.png'),
    sizes: [
  ...
  },
  {
    ...
    image: asset('8. DOUBLE WALL PAPER CUP WHITE.webp'),
    sizes: [
  ...
  },
  {
    ...
    category: 'Paper Cups',
    subcategory: 'DOUBLE WALL',
    image: asset('9. DOUBLE WALL PAPER CUP BROWN.png'),
    sizes: [
      { name: '8oz',  price: 7.3, bulkPrices: { 500: 3650, 1000: 7300, 2000: 14600, 5000: 36500 } },
      { name: '12oz', price: 7.8, bulkPrices: { 500: 3900, 1000: 7800, 2000: 15600, 5000: 39000 } },
      { name: '16oz', price: 8.5, bulkPrices: { 500: 4250, 1000: 8500, 2000: 17000, 5000: 42500 } }
  ...
  },
  {
    ...
    category: 'Paper Cups',
    subcategory: 'DOUBLE WALL',
    image: asset('10. DOUBLE WALL PAPER CUP BLACK.jpg'),
    sizes: [
      { name: '8oz',  price: 7.3, bulkPrices: { 500: 3650, 1000: 7300, 2000: 14600, 5000: 36500 } },
      { name: '12oz', price: 7.8, bulkPrices: { 500: 3900, 1000: 7800, 2000: 15600, 5000: 39000 } },
      { name: '16oz', price: 8.5, bulkPrices: { 500: 4250, 1000: 8500, 2000: 17000, 5000: 42500 } }
...
export function getPriceForQuantity(productId, sizeName, quantity) {
