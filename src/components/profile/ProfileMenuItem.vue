...
const icons = {
  ...
  // ✅ NEW — MapPin icon for Saved Addresses
  MapPin: () => h('svg', { xmlns: 'http://www.w3.org/2000/svg', width: 20, height: 20, viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 2 }, [
